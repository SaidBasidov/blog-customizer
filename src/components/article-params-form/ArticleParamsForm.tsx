			...
			<aside
				...
				<form className={styles.form} onSubmit={handleSubmit} onReset={handleReset}>
					...
					<Select
						...
						onChange={(option) => setFormState(prev => ({ ...prev, fontFamilyOption: option }))}
						title='Шрифт' />
					<RadioGroup
						name='fontSize'
						selected={formState.fontSizeOption}
						options={fontSizeOptions}
						onChange={(option) => setFormState(prev => ({ ...prev, fontSizeOption: option }))}
						title='Размер Шрифта' />
					<Select
					...
					<Select
						...
						onChange={(option) => setFormState(prev => ({ ...prev, backgroundColor: option }))}
						title='Цвет Фона' />
					<Select
